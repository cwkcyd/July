...
{
    /// <summary>
    /// Used to store JulyModuleInfo objects as a dictionary.
    /// </summary>
    internal class JulyModuleCollection : List<JulyModuleInfo>
    {
        public Type StartupModuleType { get; }

        public JulyModuleCollection(Type startupModuleType)
        {
        ...
        public List<JulyModuleInfo> GetSortedModuleListByDependency()
        {
        ...
        public static void EnsureKernelModuleToBeFirst(List<JulyModuleInfo> modules)
        {
            var kernelModuleIndex = modules.FindIndex(m => m.Type == typeof(JulyKernelModule));
        ...
        public static void EnsureStartupModuleToBeLast(List<JulyModuleInfo> modules, Type startupModuleType)
        {
